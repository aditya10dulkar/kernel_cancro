...
STRIP=/home/aditya10dulkar/android/toolchains/UBERTC-arm-eabi-5.2-9345268e3218/bin-strip
...
export CROSS_COMPILE=/home/aditya10dulkar/android/toolchains/UBERTC-arm-eabi-5.2-9345268e3218/bin/arm-eabi-
...
echo -e "${bldcya}##############${bldblu}STARTING.Darth.BUILD${bldcya}###################${txtrst}"
echo -e "${bldcya}#####################################################${txtrst}"
make -j12
...
cd $KERNEL_OUT/
zip -r ../Aditya10dulkar_Cancro_$(date +%d%m%Y_%H%M) .
